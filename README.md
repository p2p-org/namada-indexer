...
⚠️ **IMPORTANT: Tagging Process** ⚠️

This is a fork of the Namada Indexer. When upstream releases a new version, we handle it automatically:

1. When upstream (anoma/namada-indexer) creates a tag like `v1.1.7`
2. Simply push the same tag to our repository:
...
3. Our CI will automatically:
   - Checkout the upstream tag in the submodule
   - Build and push our images with the same tag

The images will be available as: `ghcr.io/p2p-org/namada-indexer/*:v1.1.7`
